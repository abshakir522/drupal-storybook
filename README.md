...
1. Navigate to the "themes/contrib/drupal-theme-base" folder change permissions to shell
...
2. The script will ask a series of configuration questions and then create your subtheme.
3. If you don't already have a "themes/custom" folder, it will create one, then place your subtheme there.
...
Update line #19 of the gulpfile.js file with your own domain.
...
This will generate a style.css file at subtheme/css folder.

## Installation

1.  Create the subtheme following above steps.
...
in Storybook. Zyrous Gesso includes npm tasks to compile design tokens, CSS, JS,
