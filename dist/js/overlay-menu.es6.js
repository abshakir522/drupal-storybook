...
/* harmony import */ var _modules_OverlayMenu_es6__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/_OverlayMenu.es6 */ "./source/03-components/overlay-menu/modules/_OverlayMenu.es6.js");




(drupal__WEBPACK_IMPORTED_MODULE_2___default().behaviors.overlayMenu) = {
  attach: function attach(context) {
    var menus = context.querySelectorAll('.c-overlay-menu');

    if (menus.length) {
      menus.forEach(function (menu) {
        var overlayMenu = new _modules_OverlayMenu_es6__WEBPACK_IMPORTED_MODULE_3__["default"](menu);
        overlayMenu.init();
      });
    }
  }
