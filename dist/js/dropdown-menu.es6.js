...
var Menu = /*#__PURE__*/function () {
   ...
   */
  function Menu(domNode, _temp) {
    var _ref = _temp === void 0 ? {} : _temp,
        _ref$useArrowKeys = _ref.useArrowKeys,
        useArrowKeys = _ref$useArrowKeys === void 0 ? true : _ref$useArrowKeys,
        _ref$displayMenuOnHov = _ref.displayMenuOnHover,
        displayMenuOnHover = _ref$displayMenuOnHov === void 0 ? true : _ref$displayMenuOnHov,
        _ref$submenuSelector = _ref.submenuSelector,
        submenuSelector = _ref$submenuSelector === void 0 ? '.c-dropdown-menu__subnav' : _ref$submenuSelector;
    ...
    this.options = {
      ...
      displayMenuOnHover: displayMenuOnHover,
  ...
  _proto.createMenuItem = function createMenuItem(menuElement) {}
  /**
  ...
  _proto.isValidTag = function isValidTag(tagName) {
  ...
  _proto.init = function init() {
    ...
    if (this.domNode.children.length > 0) {
      var nodesArray = Array.from(this.domNode.children);
      nodesArray.forEach(function (childElement) {
        var menuElement = childElement.firstElementChild;

        if (menuElement && _this.isValidTag(menuElement.tagName)) {
          var menuItem = _this.createMenuItem(menuElement);
          ...
          if (menuElement.tagName === 'BUTTON') {
            _this.options.displayMenuOnHover = false;
          }
        }
      });
    ...
    if (numItems > 0) {
      var _this$menuItems = this.menuItems;
      this.firstItem = _this$menuItems[0];
...
/***/ "./source/03-components/dropdown-menu/modules/_MenuBar.es6.js":
/*!********************************************************************!*\
  !*** ./source/03-components/dropdown-menu/modules/_MenuBar.es6.js ***!
  \********************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Menu_es6__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./_Menu.es6 */ "./source/03-components/dropdown-menu/modules/_Menu.es6.js");
/* harmony import */ var _MenubarItem_es6__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./_MenubarItem.es6 */ "./source/03-components/dropdown-menu/modules/_MenubarItem.es6.js");
...
var MenuBar = /*#__PURE__*/function (_Menu) {
   ...
   * @inheritdoc
   */
  function MenuBar(domNode, _temp) {
    var _this;
    ...
    _this = _Menu.call(this, domNode, {
      useArrowKeys: useArrowKeys,
      displayMenuOnHover: displayMenuOnHover,
      submenuSelector: submenuSelector
    }) || this; // Validate that the domNode is a menu that can be made into a MenuBar.
    ...
    while (elem) {
      ...
      if (elem && menuBarItem && !_this.isValidTag(menuBarItem.tagName)) {
        throw new Error(msgPrefix + " has child elements that are not A or Button elements. If you need to create a non-linked menu item within your menu, use '<button>' instead of '<nolink>' in the link field.");
      }

      elem = elem.nextElementSibling;
    }

    _this.isMenubar = true;
    return _this;
  }
  /**
   * @inheritdoc
  ...
  _proto.createMenuItem = function createMenuItem(menuElement) {
    return new _MenubarItem_es6__WEBPACK_IMPORTED_MODULE_1__["default"](menuElement, this);
  };

  return MenuBar;
}(_Menu_es6__WEBPACK_IMPORTED_MODULE_0__["default"]);

/* harmony default export */ __webpack_exports__["default"] = (MenuBar);

/***/ }),

/***/ "./source/03-components/dropdown-menu/modules/_MenuItem.es6.js":
/*!*********************************************************************!*\
  !*** ./source/03-components/dropdown-menu/modules/_MenuItem.es6.js ***!
  \*********************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var MenuItem = /*#__PURE__*/function () {
  ...
  _proto.handleMouseover = function handleMouseover() {
    this.hasHover = true; // Show the submenu if the outer menu is configured to display menus on hover.
  ...
  _proto.focusOnSelf = function focusOnSelf() {
    this.domNode.focus();
  }
  /**
  ...
  _proto.focusOnPreviousSibling = function focusOnPreviousSibling() {
  ...
  _proto.focusOnNextSibling = function focusOnNextSibling() {
...
/***/ "./source/03-components/dropdown-menu/modules/_MenubarItem.es6.js":
/*!************************************************************************!*\
  !*** ./source/03-components/dropdown-menu/modules/_MenubarItem.es6.js ***!
  \************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _MenuItem_es6__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./_MenuItem.es6 */ "./source/03-components/dropdown-menu/modules/_MenuItem.es6.js");
/* harmony import */ var _PopupMenu_es6__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./_PopupMenu.es6 */ "./source/03-components/dropdown-menu/modules/_PopupMenu.es6.js");
...
var MenubarItem = /*#__PURE__*/function (_MenuItem) {
  ...
  var _proto = MenubarItem.prototype;

  _proto.init = function init() {
    _MenuItem.prototype.init.call(this);

    var popupMenu = this.domNode.parentElement.querySelector(this.menu.options.submenuSelector);

    if (popupMenu) {
      this.popupMenu = new _PopupMenu_es6__WEBPACK_IMPORTED_MODULE_1__["default"](popupMenu, this, this.menu.options);
      this.popupMenu.init();
    }
  ...
  _proto.destroy = function destroy() {
    _MenuItem.prototype.destroy.call(this);
  ...
  _proto.handleKeydown = function handleKeydown(event) {
    var key = event.key;
    var flag = false;
    if (!this.menu.options.useArrowKeys && this.key !== ' ' && this.key !== 'Spacebar' && this.key !== 'Escape') return;
  ...
  return MenubarItem;
}(_MenuItem_es6__WEBPACK_IMPORTED_MODULE_0__["default"]);

/* harmony default export */ __webpack_exports__["default"] = (MenubarItem);

/***/ }),

/***/ "./source/03-components/dropdown-menu/modules/_PopupMenu.es6.js":
/*!**********************************************************************!*\
  !*** ./source/03-components/dropdown-menu/modules/_PopupMenu.es6.js ***!
  \**********************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _SubMenuItem_es6__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./_SubMenuItem.es6 */ "./source/03-components/dropdown-menu/modules/_SubMenuItem.es6.js");
/* harmony import */ var _00_config_GESSO_es6__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../00-config/_GESSO.es6 */ "./source/00-config/_GESSO.es6.js");
/* harmony import */ var _Menu_es6__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./_Menu.es6 */ "./source/03-components/dropdown-menu/modules/_Menu.es6.js");
...
var PopupMenu = /*#__PURE__*/function (_Menu) {
  _inheritsLoose(PopupMenu, _Menu);
   ...
   */
  function PopupMenu(domNode, controllerObj, _temp) {
    var _this;
    ...
    _this.controller = controllerObj;
  ...
  _proto.createMenuItem = function createMenuItem(menuElement) {
    return new _SubMenuItem_es6__WEBPACK_IMPORTED_MODULE_2__["default"](menuElement, this);
  }
  /**
   * @inheritdoc
   */
  ...
  _proto.init = function init() {
    _Menu.prototype.init.call(this); // Add event handlers.
  ...
  _proto.destroy = function destroy() {
    _Menu.prototype.destroy.call(this);
  ...
  _proto.setFocusToController = function setFocusToController(commandParam) {
  ...
  _proto.open = function open() {
    ...
    if (!this.controller.getIsMenubarItem()) {
      ...
      this.domNode.style.zIndex = _00_config_GESSO_es6__WEBPACK_IMPORTED_MODULE_3__.Z_INDEX.drawer.toString();
    } else {
      this.domNode.style.display = 'block';
      this.domNode.style.position = 'absolute';
  ...
  _proto.close = function close(force) {
    var controllerHasHover = this.controller.getHover();
    var hasFocus = this.hasFocus;

    for (var i = 0; i < this.menuItems.length; i += 1) {
  ...
  return PopupMenu;
}(_Menu_es6__WEBPACK_IMPORTED_MODULE_4__["default"]);

/* harmony default export */ __webpack_exports__["default"] = (PopupMenu);

/***/ }),

/***/ "./source/03-components/dropdown-menu/modules/_SubMenuItem.es6.js":
/*!************************************************************************!*\
  !*** ./source/03-components/dropdown-menu/modules/_SubMenuItem.es6.js ***!
  \************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var SubMenuItem = /*#__PURE__*/function (_MenuItem) {
  _inheritsLoose(SubMenuItem, _MenuItem);
   ...
   */
  function SubMenuItem(domNode, menuObj) {
    var _this;
  ...
  _proto.init = function init() {
    ...
    if (popupMenu) {
      this.popupMenu = new _PopupMenu_es6__WEBPACK_IMPORTED_MODULE_1__["default"](popupMenu, this);
      this.popupMenu.init();
    }
  ...
  _proto.handleBlur = function handleBlur() {
    _MenuItem.prototype.handleBlur.call(this);
  ...
  _proto.handleMouseover = function handleMouseover() {
    ...
    _MenuItem.prototype.handleMouseover.call(this);
  }
  /**
  ...
  _proto.handleMouseout = function handleMouseout() {
    _MenuItem.prototype.handleMouseout.call(this);
...
/* harmony import */ var _overlay_menu_modules_OverlayMenu_es6__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../overlay-menu/modules/_OverlayMenu.es6 */ "./source/03-components/overlay-menu/modules/_OverlayMenu.es6.js");
/* harmony import */ var _06_utility_cleanString_es6__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../06-utility/_cleanString.es6 */ "./source/06-utility/_cleanString.es6.js");
/* harmony import */ var _00_config_GESSO_es6__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../00-config/_GESSO.es6 */ "./source/00-config/_GESSO.es6.js");
...
var MobileMenu = /*#__PURE__*/function (_OverlayMenu) {
  _inheritsLoose(MobileMenu, _OverlayMenu);
   ...
   */
  function MobileMenu(domNode, context, _temp) {
    var _this;

    var _ref = _temp === void 0 ? {} : _temp,
        _ref$searchBlockClass = _ref.searchBlockClass,
        searchBlockClass = _ref$searchBlockClass === void 0 ? '.search' : _ref$searchBlockClass,
        _ref$utilityNavClass = _ref.utilityNavClass,
        utilityNavClass = _ref$utilityNavClass === void 0 ? '.c-menu--utility' : _ref$utilityNavClass,
        ...
        mobileMenuBreakpoint = _ref$mobileMenuBreakp === void 0 ? "(max-width: " + _00_config_GESSO_es6__WEBPACK_IMPORTED_MODULE_5__.BREAKPOINTS["mobile-menu"] + ")" : _ref$mobileMenuBreakp,
        _ref$classPrefix = _ref.classPrefix,
        classPrefix = _ref$classPrefix === void 0 ? '' : _ref$classPrefix;

    _this = _OverlayMenu.call(this, null) || this;
    _this.menu = domNode;
    _this.searchBlock = searchBlockClass ? context.querySelector(searchBlockClass) : null;
    _this.utilityNav = utilityNavClass ? context.querySelector(utilityNavClass) : null;
    _this.options = {
      toggleSubnav: toggleSubnav,
      mobileMenuBreakpoint: mobileMenuBreakpoint,
      classPrefix: classPrefix
    };
    _this.toggleMenuDisplay = _this.toggleMenuDisplay.bind(_assertThisInitialized(_this));
    return _this;
  }
  /**
  ...
  var _proto = MobileMenu.prototype;

  _proto.createMenuOverlay = function createMenuOverlay() {
  ...
  _proto.cloneBlock = function cloneBlock(block, blockClass) {
  ...
  _proto.createToggleButton = function createToggleButton(subnav) {
  ...
  _proto.setupSubnav = function setupSubnav(link, subnav) {
    var _this2 = this;

    var toggleButton = link.tagName === 'BUTTON' ? link : this.createToggleButton(subnav);
    ...
    toggleButton.addEventListener('click', function (event) {
      ...
      if (toggleButton.getAttribute('aria-expanded') === 'true') {
        ...
        _this2.enableTab(_this2.overlay);
      } else {
  ...
  _proto.cloneMenu = function cloneMenu(menu, menuClass) {
    var _this3 = this;
    ...
    var subNavTypeClass = this.options.toggleSubNav ? 'c-mobile-menu__menu--toggle-subnav' : 'c-mobile-menu__menu--show-subnav';
    menuClone.classList.add(subNavTypeClass); // Swap classes on the mobile menu items.

    var menuItems = menuClone.querySelectorAll("." + this.options.classPrefix + "__item");

    if (menuItems.length) {
      menuItems.forEach(function (item) {
        item.classList.remove(_this3.options.classPrefix + "__item");
        item.classList.add('c-mobile-menu__item');
      });
    } // Swap classes on mobile menu links.


    var menuLinks = menuClone.querySelectorAll("." + this.options.classPrefix + "__link");
    menuLinks.forEach(function (link) {
      link.classList.remove(_this3.options.classPrefix + "__link");
      link.classList.add('c-mobile-menu__link');
    }); // Swap classes on menu sections, if applicable.

    var menuSections = menuClone.querySelectorAll("." + this.options.classPrefix + "__section");

    if (menuSections.length) {
      menuSections.forEach(function (section) {
        section.classList.remove(_this3.options.classPrefix + "__section");
        section.classList.add('c-mobile-menu__section');
        var sectionInner = section.querySelector("." + _this3.options.classPrefix + "__section-inner");

        if (sectionInner) {
          sectionInner.classList.remove(_this3.options.classPrefix + "__section-inner");
          sectionInner.classList.add('c-mobile-menu__section-inner');
        }

        var sectionOverview = section.querySelector("." + _this3.options.classPrefix + "__overview");

        if (sectionOverview) {
          sectionOverview.classList.remove(_this3.options.classPrefix + "__overview");
        }
      });
    } // Prep sub-menus, if applicable.


    var subMenus = menuClone.querySelectorAll("." + this.options.classPrefix + "__subnav");

    if (subMenus.length) {
      subMenus.forEach(function (submenu, index) {
        var link = submenu.closest('.c-mobile-menu__item').querySelector('.c-mobile-menu__link'); // Swap submenu classes and ID.

        submenu.classList.add('c-mobile-menu__subnav');
        submenu.classList.remove(_this3.options.classPrefix + "__subnav");
        submenu.id = (0,_06_utility_cleanString_es6__WEBPACK_IMPORTED_MODULE_4__["default"])("mobile-menu-" + link.innerText.trim() + (index || ''));

        if (_this3.options.toggleSubnav) {
          _this3.setupSubnav(link, link.nextElementSibling);
        }
      });
    }
  ...
  _proto.toggleMenuDisplay = function toggleMenuDisplay() {
  ...
  _proto.enableTab = function enableTab(startingPoint) {
    _OverlayMenu.prototype.enableTab.call(this, startingPoint);

    if (this.options.toggleSubnav) {
      var subSections = startingPoint.querySelectorAll('.c-mobile-menu__section');
      ...
      subSections.forEach(function (subSection) {
        if (subSection.hidden || !subSection.classList.contains('is-open')) {
          var subSectionItems = subSection.querySelectorAll('button, [href], input, select, textarea, [tabindex]');
          subSectionItems.forEach(function (item) {
  ...
  _proto.init = function init() {
    ...
    if (!this.menu) return;
    this.overlay = (_this$overlay = this.overlay) != null ? _this$overlay : this.createMenuOverlay();

    _OverlayMenu.prototype.init.call(this);
    ...
    window.addEventListener('resize', function () {
      ...
      if (lastWindowWidth !== currWindowWidth) {
        ...
        resizeTimeout = setTimeout(_this4.toggleMenuDisplay, 200);
  ...
  return MobileMenu;
}(_overlay_menu_modules_OverlayMenu_es6__WEBPACK_IMPORTED_MODULE_3__["default"]);
...
var OverlayMenu = /*#__PURE__*/function () {
  /**
   * @constructor
   ...
   */
  function OverlayMenu(domNode, _temp) {
    var _ref = _temp === void 0 ? {} : _temp,
        _ref$menuButton = _ref.menuButton,
        menuButton = _ref$menuButton === void 0 ? null : _ref$menuButton,
        _ref$closeButton = _ref.closeButton,
        closeButton = _ref$closeButton === void 0 ? null : _ref$closeButton;
  ...
  var _proto = OverlayMenu.prototype;

  _proto.createMenuButton = function createMenuButton() {
  ...
  _proto.handleButtonClick = function handleButtonClick(event) {
    event.preventDefault();
    this.toggleMenu();
  }
  /**
  ...
  _proto.handleKeydown = function handleKeydown(event) {
    ...
    var focusable = Array.from(this.overlay.querySelectorAll('button, [href], input, select, textarea')).filter(function (item) {
      return item.tabIndex !== -1;
    });
    var numberFocusElements = focusable.length;
    var firstFocusableElement = focusable[0];
    var lastFocusableElement = focusable[numberFocusElements - 1];
  ...
  _proto.disableTab = function disableTab(startingPoint) {
    var menuLinks = startingPoint.querySelectorAll('button, [href], input, select, textarea, [tabindex]');
    menuLinks.forEach(function (link) {
  ...
  _proto.enableTab = function enableTab(startingPoint) {
    var menuLinks = Array.from(startingPoint.querySelectorAll('button, [href], input, select, textarea, [tabindex]')).filter(function (elem) {
...
/* harmony import */ var _mobile_menu_modules_MobileMenu_es6__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../mobile-menu/modules/_MobileMenu.es6 */ "./source/03-components/mobile-menu/modules/_MobileMenu.es6.js");
/* harmony import */ var _modules_MenuBar_es6__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/_MenuBar.es6 */ "./source/03-components/dropdown-menu/modules/_MenuBar.es6.js");





(drupal__WEBPACK_IMPORTED_MODULE_2___default().behaviors.dropdownMenu) = {
  attach: function attach(context) {
    var menuNodes = context.querySelectorAll('.c-dropdown-menu');

    if (menuNodes.length) {
      menuNodes.forEach(function (menuNode) {
        var dropdownMenu = new _modules_MenuBar_es6__WEBPACK_IMPORTED_MODULE_4__["default"](menuNode);
        dropdownMenu.init();
        var mobileMenu = new _mobile_menu_modules_MobileMenu_es6__WEBPACK_IMPORTED_MODULE_3__["default"](menuNode, context, {
...
/******/ })()
;
//# sourceMappingURL=dropdown-menu.es6.js.map