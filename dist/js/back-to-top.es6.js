...
(drupal__WEBPACK_IMPORTED_MODULE_2___default().behaviors.backToTop) = {
  attach: function attach(context, settings) {
    var _settings$gesso$backT, _settings$gesso, _settings$gesso$backT2, _settings$gesso2;

    var threshold = (_settings$gesso$backT = settings == null ? void 0 : (_settings$gesso = settings.gesso) == null ? void 0 : _settings$gesso.backToTopThreshold) != null ? _settings$gesso$backT : 200;
    var smoothScroll = (_settings$gesso$backT2 = settings == null ? void 0 : (_settings$gesso2 = settings.gesso) == null ? void 0 : _settings$gesso2.backToTopSmoothScroll) != null ? _settings$gesso$backT2 : true;
    var backToTop = context.querySelector('.c-back-to-top');
