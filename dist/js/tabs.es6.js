...
(drupal__WEBPACK_IMPORTED_MODULE_2___default().behaviors.Tabs) = {
  attach: function attach(context) {
    var tab = context.querySelectorAll(".tablinks");
    var panel = context.querySelectorAll(".tabcontent");
    ...
    function onTabClick(event) {
      ...
      var panelId = event.target.getAttribute('data-target');
